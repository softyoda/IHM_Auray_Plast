						...
						<ul class="list-group">
							...
							$eng=mysql_query("SELECT * FROM NodCap WHERE central_idcentral = ".$id_central." ") or die('Erreur SQL :' . mysql_error());
															...
															while ($data = mysql_fetch_array($eng))
															{
																...
																echo '<li class="list-group-item"> <a href="pannel.php?id='.$id_central.'#'.$data['idNodCap'].'"> Capteur numéro '.$data['idNodCap'].' de type ' .$data['TypeCap']. '</a></li>';
		...
		<div class="col-md-6">
			<div class = "panel-body">
				...
				<form enctype="multipart/form-data" action="#" method="post">
					<h2> Rajouter un capteur a la centrale <?php echo $id_central; ?></h2>
					</br>
				...
				echo '
					...
					<form enctype="multipart/form-data" action="#" method="post">
							...
							<div class="container-fluid">
								...
								<input type="submites" class="btn btn-md btn-warning pull-right" name="submites" value="Supprimer">
								</div>
						</div>
					</form>
					';
	...
	while ($data = mysql_fetch_array($eng))
	{
		...
		$le_capteur=$data['TypeCap'];//Le nom usuel
		 ...
		 echo'<div class="row">
					...
					<h2> <a href="pannel.php?id='.$id_central.'#'.$type_capteur.'"> <img src="assets/img/refresh.svg" alt="Actualiser" height="25px" width="25px" /></a>  Graphique de '.$le_capteur.' :</h2>
